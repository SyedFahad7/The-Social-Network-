...
export default function SectionDetails() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      try {
        ...
        console.log('DEBUG setStudents:', studentsArr);
        ...
        console.log('DEBUG setSubjects:', subjectsArr);
  ...
  // Helper: can teacher mark attendance for this subject/section/year?
  const canMarkAttendance = (subjectId: string) => {
    return teacherAssignments.some((a: any) => a.subject === subjectId && a.section === section && String(a.year) === String(year) && (a.academicYear === academicYear || a.academicYear?._id === academicYear));
  };
  ...
  // Add logic to fetch and set academicYearLabel from the API (e.g., from subjects, students, or a separate call if needed)
